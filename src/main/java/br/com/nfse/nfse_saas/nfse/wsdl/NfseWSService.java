 ...
 * 
 */
@WebServiceClient(name = "NfseWSService", targetNamespace = "http://nfse.abrasf.org.br", wsdlLocation = "https://nfse.issnetonline.com.br/abrasf204/goiania/nfse.asmx?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://nfse.issnetonline.com.br/abrasf204/goiania/nfse.asmx?wsdl");
    ...
    public Nfse getNfseSOAP() {
        return super.getPort(new QName("http://nfse.abrasf.org.br", "nfseSOAP"), Nfse.class);
    }
    ...
    public Nfse getNfseSOAP(WebServiceFeature... features) {
        return super.getPort(new QName("http://nfse.abrasf.org.br", "nfseSOAP"), Nfse.class, features);
    }
